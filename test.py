...
if(True):
    ...
    if text_str == "start":
        ...
        #print(MessageSegment.image(info_image_path.resolve().as_uri()))
    ...
    if text_str == "go":
        ...
        #print(MessageSegment.image(gif_path.resolve().as_uri()))
